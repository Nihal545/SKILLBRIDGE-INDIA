...
const { submitProposal, getJobProposals, getFreelancerProposals, hireFreelancer } = require('../controllers/proposal.controller');
...
router.put('/:proposalId/hire', protect, authorize('client'), hireFreelancer);
